...
//	'STEP1_CONVERT_EXPLAIN'	=> '',
	...
	'STEP1_EXT_EXPLAIN'		=> 'Did this problem start after installing or removing a extension?',
	'STEP1_EXT_ERROR'		=> 'Support questions for extensions related issues (e.g., if you have just installed a Ext and are now getting errors) should be posted within the topic of where you have downloaded the Ext. If the Ext was downloaded from another site you will have to seek support there.<br /><br /><a href="https://www.phpbb.com/community/viewforum.php?f=451">Go to the Support Forums</a>',
...
$english = array_merge($english, array(
	'SRT_QUESTIONS'			=> array(
		'step2'	=> array(
			...
			'exts_installed'	=> 'Do you have any Exts installed?',
		...
		'step3'	=> array(
			...
			'installed_exts'		=> 'What extesions do you have installed?',
...
$english = array_merge($english, array(
	'SRT_QUESTIONS_EXPLAIN'	=> array(
		...
		'step3'	=> array(
			...
			'problem_started'		=> 'Please describe the actions you took (updating your board, installing a Ext, etc.) prior to this problem becoming noticeable.',
			...
			'installed_exts'		=> 'Please try to be as detailed as you can when listing your installed Exts. This information greatly helps us in determining the cause of your problem.',
	...
	'SRT_DROPDOWN_OPTIONS'	=> array(
		'step2'	=> array(
			...
			'inst_converse'	=> array(
				null			=> 'Please select your answer',
				'fresh'				=> 'Fresh Install',
				'phpbb_update'		=> 'Update from a previous version of ',
				'convert_phpbb2'	=> 'Conversion from phpBB v2.0*',
				'convert_phpbb30'	=> 'Conversion from phpBB v3.0',
				'convert_phpbb31'	=> 'Conversion from phpBB v3.1',
				'convert_phpbb32'	=> 'Conversion from phpBB v3.2',
