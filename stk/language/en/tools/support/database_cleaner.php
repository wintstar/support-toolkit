...
$lang = array_merge($lang, array(
	...
	'DATABASE_CLEANER_WELCOME'		=> 'Welcome to the Database Cleaner tool!<br /><br />This tool was designed to remove extra columns, rows, and tables from the database not present in the default installation of phpBB, and to add missing database elements that may be needed.<br /><br />When you are ready to continue click the Continue button to start using the Database Cleaner tool (note that your board will be disabled until this is finished).',
	...
	'PHPBB_VERSION_NOT_SUPPORTED'	=> 'Your version of phpBB is not supported (or some files from the Support Toolkit are missing).<br />phpBB 3.0.0+ should be supported, but it may take some time for this tool to be updated following the release of a new version of phpBB 3.0.',
	...
	'RESET_BOTS_EXPLAIN'			=> 'Would you like to reset the bots list to the default phpBB bot list?  All existing bots will be removed and be replaced with the default set.',
	...
	'RESET_MODULES_EXPLAIN'			=> 'Would you like to reset the modules to the default phpBB modules? All existing modules will be removed and be replaced with the default ones.',
