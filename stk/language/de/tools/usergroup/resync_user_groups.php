...
$lang = array_merge($lang, array(
	...
	'RUN_RNR_NOT_FINISHED'			=> 'Die Gruppe für kürzlich registrierte Benutzer wird synchronisiert. Bitte unterbrich diesen Prozess nicht.',
	'RUN_RR'						=> 'Registrierte Benutzer synchronisieren',
	'RUN_RR_EXPLAIN'				=> 'Das Tool hat festgestellt, dass nicht alle Benutzer des Boards Mitglied der Gruppe „Registrierte <em>(COPPA-)</em>Benutzer“ sind. Möchtest du, dass diese Gruppen synchronisiert werden?<br /><strong>Hinweis:</strong> Wenn COPPA in deinem Board aktiviert ist und der Benutzer kein Geburtsdatum angegeben hat, so wird er der Gruppe „Registrierte COPPA-Benutzer“ hinzugefügt!',
	'RUN_RR_FINISHED'				=> 'Die Benutzer wurden erfolgreich synchronisiert!',

	'SELECT_RUN_GROUP'	=> 'Bitte wähle mindestens eine Gruppe aus, die synchronisiert werden soll.',
));
