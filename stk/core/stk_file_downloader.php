...
use stk_exception\stk_runtime_exception;

class stk_file_downloader
{
	const OK = 200;
	const NOT_FOUND = 404;
	 ...
	 *
	 * @throws stk_runtime_exception If data can't be retrieved and no error
	 *         message is returned
	 */
	public function get(string $host, string $directory, string $filename, int $port = 443, int $timeout = 6)
	{
		...
		catch (stk_runtime_exception $exception)
		{
